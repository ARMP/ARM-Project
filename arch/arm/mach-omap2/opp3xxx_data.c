...
struct omap_volt_data omap36xx_vddmpu_volt_data[] = {
	VOLT_DATA_DEFINE(OMAP3630_VDD_MPU_OPP50_UV, 100000, 
OMAP3630_CONTROL_FUSE_OPP50_VDD1, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP3630_VDD_MPU_OPP70_UV, 0, OMAP3630_CONTROL_FUSE_OPP100_VDD1, 0xf9, 0x12, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP3630_VDD_MPU_OPP85_UV, 0, OMAP3630_CONTROL_FUSE_OPP100_VDD1, 0xf9, 0x10, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP3630_VDD_MPU_OPP65_UV, 0, OMAP3630_CONTROL_FUSE_OPP100_VDD1, 0xf9, 0x14, OMAP_ABB_NOMINAL_OPP),
...
OMAP3630_CONTROL_FUSE_OPP1G_VDD1, 0xfa, 0x25, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP3630_VDD_MPU_OPP11G_UV, 0,
...
OMAP3630_CONTROL_FUSE_OPP1G_VDD1, 0xfa, 0x29, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP3630_VDD_MPU_OPP12G_UV, 0,
OMAP3630_CONTROL_FUSE_OPP1G_VDD1, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP3630_VDD_MPU_OPP13G_UV, 0,
OMAP3630_CONTROL_FUSE_OPP1G_VDD1, 0xfa, 0x33, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0),
};
...
static struct omap_opp_def __initdata omap36xx_opp_def_list[] = {
	/* MPU OPP1 - OPP20 */
	OPP_INITIALIZER("mpu", "dpll1_ck", "mpu_iva", true,  200000000, OMAP3630_VDD_MPU_OPP65_UV),
	/* MPU OPP1 - OPP50 */
	OPP_INITIALIZER("mpu", "dpll1_ck", "mpu_iva", true,  400000000, OMAP3630_VDD_MPU_OPP50_UV),
	/* MPU OPP1 - OPP50 */
	OPP_INITIALIZER("mpu", "dpll1_ck", "mpu_iva", true,  500000000, OMAP3630_VDD_MPU_OPP70_UV),
	/* MPU OPP1 - OPP50 */
	OPP_INITIALIZER("mpu", "dpll1_ck", "mpu_iva", true,  600000000, OMAP3630_VDD_MPU_OPP85_UV),
	/* MPU OPP2 - OPP100 */
	...
	/* MPU OPP4 - OPP-SB */
	OPP_INITIALIZER("mpu", "dpll1_ck", "mpu_iva", true,
				1000000000, OMAP3630_VDD_MPU_OPP11G_UV),
	/* MPU OPP4 - OPP-SB */
	OPP_INITIALIZER("mpu", "dpll1_ck", "mpu_iva", true,
				1100000000, OMAP3630_VDD_MPU_OPP1G_UV),
	/* MPU OPP5 - OPP-SB */
	OPP_INITIALIZER("mpu", "dpll1_ck", "mpu_iva", true,
				1200000000, OMAP3630_VDD_MPU_OPP12G_UV),
	/* MPU OPP5 - OPP-SB */
	OPP_INITIALIZER("mpu", "dpll1_ck", "mpu_iva", true,
				1300000000, OMAP3630_VDD_MPU_OPP13G_UV),
